...
## En ocasiones el rango de subred no termina en punto, necesitaremos formarlo.
#
...
foreach($r in $rango_ip)
{
	...
	$responde = Test-Connection $actual -Quiet -Count 1 # Validamos conexion contre ip en $actual
	if ( $responde -eq 'True' )
	{	
		Write-Output ''
